    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <div><input type="button" class="btn btn-success float-right" wire:click="storeQuote" value="Grabar"></div>
                Fecha
            ...
            <div class="card-footer">
                <div class="form-group">
                    ...
                    <div><input type="button" class="btn btn-success float-right mt-2" wire:click="storeQuote" value="Grabar"></div>
                  </div>        
            </div>
        </div>
    </div>
