    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <div><input type="button" class="btn btn-success float-right" wire:click="updateQuote" value="Actualizar"></div>
                Cotización <strong>{{ $quote->id }}</strong><br>
                Cotizado <strong>{{ date('d-m-Y') }}</strong>
                <div>Usuario: {{ $quote->user->name }}</div>
                ...
                <div class="row mb-4">
                    <div class="col-sm-12">
                        <h6 class="mb-3">Clientes:</h6>
                            ...
                            <input type="text" class="form-control" value="{{ $quote->customer->name . " " . $quote->customer->lastname }}" disabled>
                    </div>                      
