...
@section('content_header')
    <h1>Ver Factura de Compra</h1>
@stop

@section('content')
<div class="text-right mt-3">
    <a href="{{ route('admin.purchases-list') }}" class="btn btn-success"><i class="fas fa-arrow-left"></i> Regresar</a>
    <a href="{{ route('admin.generatepurchase', $purchase->id) }}" class="btn btn-danger"><i class="fas fa-file-pdf"></i> PDF</a>
</div>
