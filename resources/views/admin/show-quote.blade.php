...
<div class="text-right mt-3">
    <a href="{{ route('admin.quotes-list') }}" class="btn btn-success"><i class="fas fa-arrow-left"></i> Regresar</a>
    <a href="{{ route('admin.generatequote', $quote->id) }}" class="btn btn-danger"><i class="fas fa-file-pdf"></i> PDF</a>
</div>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            Fecha de pago: {{ $quote->paid_date }}<br />
                            Vencimiento: {{ $quote->due_date }}<br />
                            Status: {{ $quote->status }}
                        </td>
                    </tr>
                </table>
        ...
        <tr class="information">
            <td colspan="5">
                <table>
                    ...
                    <tr>
                        <td>
                            <strong>RNC CLIENTE:</strong> {{ $quote->customer->rfc }}<br />
                            <strong>NOMBRE O RAZON SOCIAL:</strong> {{ $quote->customer->company }}<br />
                        </td>
                    </tr>
                </table>
            </td>
