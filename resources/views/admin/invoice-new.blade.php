...
document.addEventListener('newInvoiceSweetalert', () => {
    Swal.fire({
        position: "top-end",
        icon: "success",
        title: "Factura Agregada Exitosamente",
        showConfirmButton: false,
        timer: 1500
    });
})

document.addEventListener('updateInvoiceSweetalert', () => {
    Swal.fire({
        position: "top-end",
        icon: "success",
